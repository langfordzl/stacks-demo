...
# ``stacks_demo/resources/model-workflow-resource.yml``
#
# Parameters:
...
dbutils.widgets.text(
    "model_name", "dev.stacks_demo.stacks-demo-model", label="Full (Three-Level) Model Name"
)
