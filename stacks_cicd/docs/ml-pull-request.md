...
Opening a pull request will trigger a[workflow](../.github/workflows/stacks_cicd-run-tests.yml) 
...
Links:
* [Staging model in UC](https://e2-demo-field-eng.cloud.databricks.com/explore/data/models/staging/stacks_cicd/stacks_cicd-model)
* [Prod model in UC](https://e2-demo-west.cloud.databricks.com/explore/data/models/prod/stacks_cicd/stacks_cicd-model)
. 
