...
git add README.md docs .gitignore stacks_cicd/resources/README.md
...
* You must be a Databricks workspace admin in the staging and prod workspaces. 
  ...
  [prod workspace admin console](https://e2-demo-west.cloud.databricks.com#setting/accounts). 
...
If you want to use different catalog names, please update the target names declared in the[stacks_cicd/databricks.yml](../stacks_cicd/databricks.yml) file.
...
Follow the instructions in [stacks_cicd/resources/README.md](../stacks_cicd/resources/README.md) to deploy ML resources
and production jobs.
...
[ML resource config guide](../stacks_cicd/resources/README.md)  to propose, test, and deploy
